use super::submission::{validate_submit_proof_request_wire_v1, GenerateSubmitProofRequestV1};
use crate::udot::normalize_udot_hash;
use crate::{AuraSdkErrorV1};
use super::{generate_submit_proof_request_v1, SubmitProofRequestWireV1};
use serde::{Deserialize, Serialize};

/// ```compile_fail
/// use aura_sdk_v1::{legacy::GenerateAuthorizationIntentV1, legacy::GenerateSubmitProofRequestV1};
///
