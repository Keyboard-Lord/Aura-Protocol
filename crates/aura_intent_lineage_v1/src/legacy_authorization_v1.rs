//! Historical intent/envelope serialization and authorization validation.
//! Preserved for explicit legacy consumers; not the Bitcoin Authorization V2 owner.

use core::fmt;
use crate::{sha256_bytes, LowerHex32, HASH_LEN_V1};
