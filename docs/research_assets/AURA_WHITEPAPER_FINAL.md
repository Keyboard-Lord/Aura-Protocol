...
> **Scope Boundary:** This document is RESEARCH ONLY. It records research context, historical exploration, and supporting material. It does NOT define active protocol authority.
> **Canonical Reference:** AURA_SINGLE_PATH_COMMITMENT_SYSTEM_V2.md (docs/authoritative/)
> **Critical Disclaimer:** The "Arnold cat map" (linear recurrence) described in this document is RESEARCH CONTEXT ONLY. The active protocol uses the quadratic STORM recurrence defined in AURA_STORM_RECURSION_V1_1.md.
> **Interpretation Rule:** Read the body as supporting context only. Do NOT implement from this document. Candidate, future, audit, or comparison language is non-authoritative.
> **Implementation State:** RESEARCH ONLY — NON-AUTHORITATIVE
...
A separate supporting research note, AURA_DODECAHEDRAL_EMA_NOTE_V1.md, describes an optional future upstream bounded-input overlay. The layer is RESEARCH / SUPPORTING, emits `(x0, y0)`, and does not modify active protocol. EMA does NOT affect AIR. Research layers do NOT affect settlement.
...
The whitepaper does NOT define execution. Executable root scripts and implemented code define the single authoritative pipeline.

![System pipeline from proof preparation to Solana settlement adapter.](docs/whitepaper_assets/fig_system_pipeline.svg)
...
![Cat-map matrix equation.](docs/whitepaper_assets/eq_cat_map_matrix.svg)
...
![Cat-map coordinate recurrence.](docs/whitepaper_assets/eq_cat_map_recurrence.svg)
...
![Cat-map forward and inverse transformation diagram.](docs/whitepaper_assets/fig_cat_map_transform.svg)
...
![Trace commitment structure.](docs/whitepaper_assets/fig_trace_commitment.svg)
...
![Proof verification flow.](docs/whitepaper_assets/fig_proof_verification_flow.svg)
...
![Transition binding tuple.](docs/whitepaper_assets/eq_binding_tuple.svg)
