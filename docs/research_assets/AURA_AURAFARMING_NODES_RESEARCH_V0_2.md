<!-- HISTORICAL RESEARCH ARCHIVE — NOT ACTIVE PROTOCOL AUTHORITY.
Preserved from docs/authoritative/AURA_AURAFARMING_NODES.md during M7.
The active file at that stable path now owns the approved coordinated Miner V1.
The original text below is retained as evidence, including unsupported claims. -->
